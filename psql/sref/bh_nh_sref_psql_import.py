...
def main():
	...
	path = '/home/btober/Documents/sref/bh_nh_bt/'
	...
	for filename in os.listdir(path):
		if(filename.endswith('.csv')):
			...
			dline = data[0].split(',')
			del data[-1]
			insstr = "INSERT INTO sref.bh_nh VALUES ({}, {}, {}, {}, {}, {})".format(int(float(dline[0])), int(float(dline[1])), dline[7], dline[6], dline[11], dline[-1])
